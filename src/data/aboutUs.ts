...
export const aboutUs: AboutPageContent = {
  meta: {
    ...
    description:
      "Meet the team behind ProElite Movers — a Miami Lakes moving agency built on honest hourly billing, real care, and a human approach.",
  },
  hero: {
    eyebrow: "Meet The Founders",
    title: "A Moving Agency, Not Just a Truck",
    subheadline: "Meet Luis and Juan, the founders behind ProElite Movers.",
    image: {
    ...
    cards: [
      {
        ...
        layout: "wide",
        label: "The Problem",
        body: "Most moving companies treat your move like a transaction, not like something that involves someone's actual life. We started ProElite Movers to do it differently: listen first, plan the details, then move you.",
      },
      {
        id: "where-we-stand",
        layout: "tall",
      ...
      },
      {
        ...
        layout: "cta",
        label: "Next Step",
        body: "If this sounds like the team you want handling your move, reach out — we'll go over the details.",
